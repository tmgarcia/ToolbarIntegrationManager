    ...
    public class ImageStates
    {
        ...
        public string ActivePath 
        {
            ...
            set
            {
                ...
                activeImage.UriSource = new Uri("pack://application:,,,/TIM;component/" + _activePath);
                activeImage.EndInit();
        ...
        public string ActiveHoverPath
        {
            ...
            set
            {
                ...
                activeHoverImage.UriSource = new Uri("pack://application:,,,/TIM;component/" + _activeHoverPath);                
        ...
        public string ActivePressedPath
        {
            ...
            set
            {
                ...
                activePressedImage.UriSource = new Uri("pack://application:,,,/TIM;component/" + _activePressedPath);
        ...
        public string InactivePath
        {
            ...
            set
            {
                ...
                inactiveImage.UriSource = new Uri("pack://application:,,,/TIM;component/" + _inactivePath);
        ...
        public string InactiveHoverPath
        {
            ...
            set
            {
                ...
                inactiveHoverImage.UriSource = new Uri("pack://application:,,,/TIM;component/" + _inactiveHoverPath);
        ...
        public string InactivePressedPath
        {
            ...
            set
            {
                ...
                inactivePressedImage.UriSource = new Uri("pack://application:,,,/TIM;component/" + _inactivePressedPath);
        ...
        public string DisabledPath
        {
            ...
            set
            {
                ...
                disabledImage.UriSource = new Uri("pack://application:,,,/TIM;component/" + _disabledPath);
